...
<?php 
	...
	$todo1 = '?action=sales&todo=payment_history_and_sales_search';
	...
	if( isset( $data['all_stores'] ) && $data['all_stores'] ){
		$all_stores = 1;
		$todo1 = '?action=sales&todo=payment_history_and_sales_search_all';
		
		switch( $package ){
		case "hotel":
			$todo1 = '?action=hotel_checkin&todo=payment_history_and_sales_search_all';
		break;
		}
	}	
?>
	...
	<div class="col-md-7"> 
		...
		<div class="portlet  box">
			<div class="portlet-body" style=" background:transparent;">
				...
				<div class="row">
					<div class="col-md-4">
					<select class="form-control" onchange="nwRecordPayment.search();" placeholder="Select Customer" name="customer">
				...
				<div id="main-table-view" class="portlet-body1 shopping-cart-table" style="background:transparent !important;">
				 <div class="tabbable-custom nav-justified">
					<ul class="nav nav-tabs nav-justified">
					   <li class="active"><a href="#transactions" data-toggle="tab">Transactions [Sales Order]</a></li>
		...
		<div style="background:transparent !important; border:none !important;" class="grey box portlet <?php if( ! ( isset( $data['mobile_enabled'] ) && $data['mobile_enabled'] ) ){ ?>grey box<?php } ?>">
			<div class="portlet-body1 shopping-cart-table allow-scroll-1" style="background:transparent !important;">
				...
				<form class="activate-ajax" method="post" id="cart" action="?action=cart&todo=save_record_payment">
					 ...
					 <input type="hidden" name="customer" class="form-control" value="" />
					 <input type="hidden" name="reference_table" class="form-control" value="" />
					 <input type="hidden" name="extra_reference" class="form-control" value="" />
					...
					<div class="row">
						<div class="col-md-12">
							<div class="input-group">
							 <span class="input-group-addon" style="color:#777; line-height: 1.5;">Sales Order No.</span>
						...
						<div class="col-md-12">
							<div class="input-group">
							 ...
							 <input type="number" step="any" min="0.01" class="form-control" name="amount_paid" value="0">
							</div>
							<br />
						</div>
						<div class="col-md-12">
