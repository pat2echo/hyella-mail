			...
			<div class="portlet-body" style="background:transparent;">
				...
				<div id="cart-category">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="btn-toolbar margin-bottom-10 pull-right2">
								<?php if( $server ){ ?>
	...
	<div class="col-md-6" >
		...
		<div class="portlet box purple" id="new-picking-slip">
			<div class="portlet-title">
				<div class="caption"><small><small>New Stock Requisition Slip</small></small></div>
			</div>
			<div class="portlet-body">
				   ...
				   <div class="well" style="padding:10px;">
					<p><strong>Date:</strong> <?php echo date("d-M-Y"); ?></p>
					  <ul class="list-unstyled">
						 <li><strong>Stock Req. Slip No:</strong> [New]</li>
			  ...
			  <div class="row">
				...
				<div class="row">
					<div class="col-xs-12">
						<br />
						<a class="btn pull-right red custom-single-selected-record-button" action="?module=&action=cart&todo=save_general_picking_slip" id="cart-finish" href="#">Save Request</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="portlet box purple" >
			<div class="portlet-title">
				<div class="caption"><small><small>Stock Requisition History (10 Most Recent)</small></small></div>
			</div>
			<div class="portlet-body">
			  <div class="row">
				  <div class="col-xs-12">
