var nwCart = function () {
	return {
		...
		refreshCart: function () {	
			...
			if( tt ){
				htmlf += "<tr><td colspan='5'>&nbsp;</td></tr><tr><th class='r' colspan='2'>TOTAL</th><th class='r'>"+nwCart.addComma( tq )+"</th><th class='r'>"+nwCart.addComma( td )+"</th><th class='r'>"+ nwCart.addComma( tt.toFixed(2) ) +"</th></tr>";
