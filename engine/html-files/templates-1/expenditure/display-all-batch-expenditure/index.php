...
<div class="row" >
	<div class="col-md-2 mobile-settings-view"> 
		<div class="portlet grey box">
			<div class="portlet-title">
				<div class="caption"><i class="icon-globe"></i><small><small>Batch Payment</small></small></div>
			</div>
			<div class="portlet-body" style="max-height:470px; overflow-y:auto;">
				...
				<?php 
					$t2 = "";
					if( isset( $data[ 'report_title2' ] ) ){
						$t2 = $data[ 'report_title2' ];
					}
				?>
				<label style="font-weight:bold; font-size:11px;">Select <?php echo $t2; ?></label>
				<select id="report-pen" class="form-control" style="font-size: 12px; padding: 2px 5px; height: 28px; font-weight: bold;">
					<option value="all-items">All <?php echo $t2; ?></option>
					<?php 
						$sel = "";
	...
	<div class="col-md-10 mobile-main-view" id="main-table-view"> 
		<div style="padding-bottom:50px; min-height:480px; max-height:500px; overflow-y:auto;" id="data-table-section">
			<?php //include dirname( dirname( __FILE__ ) ) . "/batch-payment-process.php"; ?>
		</div>
