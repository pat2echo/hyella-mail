<?php
	...
	<?php } ?>
		...
		<div style="height:34px; margin-bottom:5px;">
			<span style="width:60px; float:left; line-height:15px; text-align:center; font-size:8px;"><?php if( isset( $val[ "category" ] ) )echo ( isset( $cat[ $val[ "category" ] ] )?$cat[ $val[ "category" ] ]:$val[ "category" ] ); ?><?php if( isset( $val[ "weight" ] ) )echo '<br />' . $val[ "weight" ]; ?></span>
