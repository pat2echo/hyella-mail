	...
	if( isset( $data["barcodes"] ) && $data["barcodes"] ){
		...
		?>
			...
			<div style="height:80px; margin-bottom:3px;">
				<span style="width:45px; float:left; line-height:15px; text-align:left; font-size:10px;">
					<span style="font-size:11.5px;">
						SHOPWAZOBIA
					</span><br />
					<span>09096666884</span><br />
					<span>09053019322</span><br />
					<span style="text-decoration:underline;">www.shopwazobia.com</span>
				</span>
				...
				<span style="width:90px; float:right; text-align:center;">
				<div style="font-size:9px; line-height:10px;">Baby shoes with cream dress</div><br />
