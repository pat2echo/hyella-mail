...
<?php
	...
	$disable_quantity_picked = get_disable_quantity_picked_in_sales_picking_slips_settings();
?>
<?php
	if( isset( $e ) ){
?>
<div class="portlet box purple" id="new-picking-slip">
	...
	<div class="portlet-body">
		<h4>Premium Poultry Farms Limited - Picking Slips</h4>
		<div class="row">
		   <div class="col-xs-6">
			  <p>Invoice Number: <strong>#<?php echo mask_serial_number( $e["serial_num"] , 'S' ); ?></strong></p>
		   ...
		   <div class="well" style="padding:10px;">
			<p><strong>Date:</strong> <?php echo date("d-M-Y"); ?></p>
			  <ul class="list-unstyled">
				 <li><strong>Picking Slip No:</strong> [New Picking Slip]</li>
					...
					if( isset( $s ) && is_array( $s ) && ! empty( $s) ){
						...
						foreach( $s as $items ){
							...
							<tr class="picked-item" id="<?php echo $items["item_id"]; ?>" data-title="<?php echo $title1; ?>" data-max="<?php echo $q; ?>" data-quantity_picked="<?php echo $q1; ?>"  data-cost_price="<?php echo $items["cost_price"]; ?>">
							   ...
							   <?php if( $disable_quantity_picked ){ ?>
