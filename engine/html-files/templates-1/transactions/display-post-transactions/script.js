var nwTransactions = function () {
	return {
		...
		emptyCart: function(){
			...
			$('select[name="account2"]').select2("val", "");
			$('select[name="account3"]').select2("val", "");
			$('select[name="extra_reference"]').select2("val", "").empty();
