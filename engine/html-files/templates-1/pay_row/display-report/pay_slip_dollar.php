	...
	if( ! empty( $report_data ) ){
		...
		foreach( $report_data as $sval ){
			...
			$body = '<tr>';
				...
				$name = '<img src="'.$pr["domain_name"].'files/resource_library/logo.jpg" width="42" align="left" />' . "<small><br />" . $pr["project_title"] . "</small><small><br /><br /><br /></small>" . ( isset( $emp[ $sval["staff_name"] ] )?( $emp[ $sval["staff_name"] ]["lastname"] . " " .$emp[ $sval["staff_name"] ]["firstname"] ):"N/A" ) . " - Pay Slip";
			...
			<tr>
				...
				<th>Earnings ($)</th>
				<th>Deductions ($)</th>
				<th class="company alternate">Net Pay ($)</th>
			</tr>
		</thead>
		<tbody>
		<?php echo $body; ?>
