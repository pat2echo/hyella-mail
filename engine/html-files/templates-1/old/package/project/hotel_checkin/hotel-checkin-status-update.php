...
<div class="page-container">
	...
	<div class="tabbable-custom nav-justified">
		<ul class="nav nav-tabs nav-justified">
		   ...
		   <?php if( isset( $data['payment_history'] ) ){ ?><li><a href="#tab_1_1_a" data-toggle="tab">Refund / Payment History</a></li><?php } ?>
