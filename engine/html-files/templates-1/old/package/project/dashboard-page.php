			...
			<div class="pull-left">
				<ul class="nav nav-tabs">
				   ...
				   <?php
						...
						if( isset( $access[ $key ] ) || $super ){
					?>
				   <li><a href="#portlet_tab_project_management" module-name="Project Management" function-id="1" function-class="files" function-name="display_main_menu_full_view" class="custom-action-buttonAX" data-toggle="tab">PROJECT MANAGEMENT</a></li>
				   <?php } ?>
		...
		<div class="tab-content">
			<div class="tab-pane active" id="portlet_tab1">
				  ...
				  <div class="row" style="margin:10px 0;">
					...
					?>
					<div class="col-sm-2 col-md-1 border-right  " style="text-align:center;">
						<a href="#" class="icon-btn top-bar-icon custom-action-button" href="#" id="8270082579" function-id="8270082579" function-class="expenditure" function-name="display_all_records_full_view" module-id="1412705497" module-name="Expenditures" title="Click Here to View Expenditures">
							<i class="icon-money" style="color:#d2322d;"></i>
			...
			<div class="tab-pane" id="portlet_tab2">
				  ...
				  <div class="row" style="margin:10px 0;">
					...
					?>
					<div class="col-sm-2 col-md-1 border-right  " style="text-align:center;">
						<a href="#" class="icon-btn top-bar-icon custom-action-button" href="#" id="8270082579" function-id="8270082579" function-class="hotel_checkin" function-name="display_all_reports_full_view" module-id="1412705497" module-name="Hotel Room Manager" title="Click Here to View Hotel Room Reports">
							<i class="icon-book" style="color:#d2322d;"></i>
					...
					?>
					<div class="col-sm-2 col-md-1 border-right  " style="text-align:center;">
						<a href="#" class="icon-btn top-bar-icon custom-action-button" href="#" id="8270082579" function-id="8270082579" function-class="hotel_checkin" function-name="display_night_reports_full_view" module-id="1412705497" module-name="Night Audits Manager" title="Click Here to View Nightly Audits of All Transactions">
							<i class="icon-book" style="color:#d2322d;"></i>
							<div>Night Audit</div>
						</a>
					</div>
			...
			<div class="tab-pane" id="portlet_tab_project_management">
				  <!-- BEGIN HORIZANTAL MENU -->
				  <div class="row" style="margin:10px 0;">
					
					<div class="col-sm-2 col-md-1 border-right  " style="text-align:center;">
						<a href="#" class="icon-btn top-bar-icon custom-action-button" href="#" id="8270082579" function-id="8270082579" function-class="project" function-name="display_all_records_full_view" module-id="1412705497" module-name="Chart of Accounts" title="Click Here to View Chart of Accounts">
							<i class="icon-book" style="color:#d2322d;"></i>
					...
					<div class="col-sm-2 col-md-1 border-right  " style="text-align:center;">
						<a href="#" class="icon-btn top-bar-icon custom-action-button" href="#" id="8270082579" function-id="8270082579" function-class="project_task" function-name="display_all_records_full_view" module-id="1412705497" module-name="Transaction" title="Click Here to View Transactions">
							<i class="icon-book" style="color:#d2322d;"></i>
					...
					<div class="col-sm-2 col-md-1 border-right  " style="text-align:center;">
						<a href="#" class="icon-btn top-bar-icon custom-action-button" href="#" id="8270082579" function-id="8270082579" function-class="project_task_status" function-name="display_all_records_full_view" module-id="1412705497" module-name="Layer Farm Manager" title="Click Here to View Debit & Credit">
							<i class="icon-book" style="color:#d2322d;"></i>
							<div>Task Status</div>
						</a>
					</div>
			...
			<div class="tab-pane" id="portlet_tab4">
				<div class="row" style="margin:10px 0;">
					...
					<?php } ?>
						...
						<div class="col-sm-2 col-md-1 border-right" style="text-align:center;">
							<a href="#" class="icon-btn top-bar-icon custom-action-button" href="#" id="8270082579" function-id="8270082579" function-class="banks" function-name="display_all_records_full_view" module-id="1412705497" module-name="Settings" title="Banks Manager" budget-id="-" month-id="-">
								<i class="icon-money" style="color:#d2322d;"></i>
								<div>&nbsp;Banks&nbsp;</div>
							</a>
						</div>
