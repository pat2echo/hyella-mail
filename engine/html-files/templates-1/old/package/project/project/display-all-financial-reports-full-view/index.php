	...
	<div class="col-md-2 resize-drag"> 
		<div class="portlet grey box">
			<div class="portlet-title">
				<div class="caption"><i class="icon-globe"></i><small><small>Income Report</small></small></div>
			...
			<div class="portlet-body" id="tree-view-selector-container" style="max-height:420px; overflow-y:auto;">
				...
				<label style="font-weight:bold; font-size:11px;">Source of Income</label>
				<select id="report-pen" class="form-control" style="font-size: 12px; padding: 2px 5px; height: 28px; font-weight: bold;">
					<option value="all-expenses">All Sources<option>
					<?php 
						$sel = "";
				...
				<hr />
					<a href="#" budget-id="-" month-id="-" operator-id="-" department-id="-" function-id="activate_report_year" function-class="events" function-name="get_financial_reports" id="activate_report_year" class="btn btn-success custom-action-button">Generate Report</a>
		...
		<div class="portlet box purple">
			<div class="portlet-body" style="padding-bottom:50px; min-height:480px; max-height:500px; overflow-y:auto;" id="data-table-section">
				<div style="text-align:center;">
					<h5><strong>Income Report</strong></h5>
					<img src="images/gold.png" style="max-width:200px;" />
					<br /><br /><h1>Select Reporting Year</h1><br /><br />
