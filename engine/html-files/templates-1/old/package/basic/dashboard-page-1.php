					...
					<div class="tab-pane" id="portlet_tab3">
						  ...
						  <div class="row" style="margin:10px 0;">
							...
							<div class="col-md-3 border-right" style="text-align:center;">
								...
								?>
								<div class="btn-group btn-group-justified">
                                    <a href="#" class="btn btn-sm btn-default btn-bordered custom-action-button align-left" module-name="Hall Manager" title="Click Here to View All Pay Row" function-id="1" function-class="pay_row" function-name="display_all_records_full_view"><i class="icon-list"></i> Pay Row</a>
