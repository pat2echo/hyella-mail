		   ...
		   ?>
			<div id="discount-container-1" style="<?php echo $dstyle; ?>">
				<div class="input-group">
				 ...
				 <button class="btn dark custom-action-button" type="button" function-name="manage_discount_hotel_group_checkin" function-class="discount" function-id="Manage Discount" skip-title="1" >Manage Discount</button>
				 </span>
			  </div>
			</div>
			<hr />
