...
<?php
	...
	?>
	<tr><td colspan="4" rowspan="<?php echo count( $total ) + 1; ?>"><h4><strong><?php echo $title; ?></strong></h4><br /><p><?php echo $subtitle; ?></p></td><td colspan="4" ><h5>SUMMARY</h5></td></tr>	
	<?php
...
<tr>
		...
		<th rowspan="2" class="landscape-only">Status</th>
		
		<th colspan="4">Sales Info</th>
