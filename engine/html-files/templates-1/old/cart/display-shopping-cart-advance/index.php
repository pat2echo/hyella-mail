...
<?php 
	...
	$show_date = 0;
	if( ( isset( $data["backdate_sales"] ) && $data["backdate_sales"] ) ){
		$show_date = 1;
	}
?>
<!--EXCEL IMPOT FORM-->
<div class="row" >
	...
	<div class="col-md-3" id="cart-checkout-container"> 
		...
		<div class="input-group">
		 ...
		 <input type="date" name="date" class="form-control" value="<?php echo date("Y-n-d"); ?>" />
		</div>
		<br />
		<?php } ?>
		<div class="input-group">
		...
		<div id="use-customer-deposit">
			<br />
			 <div class="input-group">
			 <span class="input-group-addon" style="color:#777;">Payment Option</span>
			  <select class="form-control" name="payment_option">
				<option value="">-Select-</option>
				<?php
					$pml = get_payment_method_list();
					if( isset( $pml ) && is_array( $pml ) ){
						foreach( $pml as $key => $val ){
							?>
							<option value="<?php echo $key; ?>">
								<?php echo $val; ?>
							</option>
...
<script type="text/javascript" class="auto-remove">
	...
	var g_discount_after_tax = <?php echo $discount_after_tax; ?>;
