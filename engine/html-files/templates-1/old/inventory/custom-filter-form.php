...
<form class="activate-ajax" method="post" id="inventory" action="?action=inventory&todo=filter_inventory_search_all">
	<div class="row">
		<div class="col-md-12">
		<label>Item Description</label>
		<select class="form-control select2" placeholder="Select Item" name="item">
