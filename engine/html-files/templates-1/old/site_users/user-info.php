...
<div class="row" style="background:#fff; padding-bottom:20px; border:1px solid #ddd;">
	<div class="col-md-3" style="text-align:center;">
		...
		?>
			<img src="<?php echo $site_url ."engine/". $data["user_info"][$key]; ?>" style="max-width:100%; margin-top:20px;" /> 
			<?php
		}else{
			?>
			<h3 >
	...
	<div class="col-md-9">
		<h3>
			...
			<br />
			<br />
			<?php $key = "department"; if( isset( $data["user_info"][$key] ) && $data["user_info"][$key] )echo "<strong>DEPTARTMENT:</strong> " . get_select_option_value( array( "id" => $data["user_info"][$key], "function_name" => "get_departments" ) ) ; ?>
			</small>
			</div>
		</h3>
	</div>
