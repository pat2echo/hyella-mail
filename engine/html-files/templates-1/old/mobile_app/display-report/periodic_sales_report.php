...
<?php
	...
	<tr><td colspan="3" rowspan="<?php echo count( $total ) + 1; ?>"><h4><strong id="e-report-title"><?php echo $title; ?></strong></h4><br /><p><?php echo $subtitle; ?></p></td><td colspan="4" ><h5>SUMMARY</h5></td></tr>	
	<?php
...
<tr>
		...
		<th colspan="3">Income Generated</th>
		<th colspan="2">Income Collected</th>
	</tr>
	<tr>
		<th>Value of Goods Sold</th>
		<th>Discount</th>
		<th class="company">Expected Income</th>
		
		<th>Cash Received</th>
		<th class="company">Outstanding</th>
	</tr>
</thead>
<tbody>
<?php echo $body; ?>
