...
<?php
	...
	?>
	<tr><td colspan="4" rowspan="<?php echo count( $total ) + 1; ?>"><h4><strong id="e-report-title"><?php echo $title; ?></strong></h4><br /><p><?php echo $subtitle; ?></p></td><td colspan="6" ><h5>SUMMARY</h5></td></tr>	
	<?php
