...
<!-- BEGIN CONTAINER -->   
	<div class="container" id="invoice-container">
		...
		<div class="row">
		   ...
		   <div class="col-xs-4 ">
			  <h4><small>Status:  <small><strong><?php $key = "status"; if( isset( $data["event"][$key] ) )echo get_select_option_value( array( "id" => $data["event"][$key], "function_name" => "get_transaction_status" ) ); ?></strong></small></small></h4>
			  <ul class="list-unstyled">
