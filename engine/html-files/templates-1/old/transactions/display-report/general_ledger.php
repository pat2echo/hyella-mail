...
<?php
	...
	if( ! empty( $report_data ) ){
		...
		foreach( $r as $key => $rv ){
			...
			$body .= '<tr class="total-row"><td class="item-desc" colspan="'. ( $span - 2 ) .'"><strong>ACCOUNT TOTAL '. strtoupper( $key ) .'</strong></td><td class="item-amount"><strong>'. format_and_convert_numbers( $grand_total_d, 4 ) .'</strong></td><td class="item-amount"><strong>'. format_and_convert_numbers( $grand_total_c, 4 ) .'</strong></td></tr>';
