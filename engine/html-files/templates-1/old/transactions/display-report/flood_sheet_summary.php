...
<?php
	...
	if( ! empty( $report_data ) ){
		...
		foreach( $r as $key => $rv ){
			...
			$body .= '<tr class="total-row"><td class="item-desc"><strong>Total '. ucwords( $key ) .'</strong></td><td class="item-amount"><strong>'. format_and_convert_numbers( $total, 4 ) .'</strong></td><td class="item-amount"><strong>'. format_and_convert_numbers( $total1, 4 ) .'</strong></td></tr>';
		...
		if( $grand_total ){
			$body .= '<tr class="total-row"><td class="item-desc"><strong>GRAND TOTAL</strong></td><td class="item-amount"><strong>'. format_and_convert_numbers( $grand_total, 4 ) .'</strong></td><td class="item-amount"><strong>'. format_and_convert_numbers( $grand_total1, 4 ) .'</strong></td></tr>';
		}
	}
