...
var pagepointer = $('#pagepointer').text() + "engine/";
//var pagepointer = 'http://192.168.1.7/dev-3/engine/';
...
function custom_function_before_ajax_processing( data ){
	...
	if( data.status ){
        ...
        case "declined-visit":
            if( data.visit_card ){
                $('#visit-card-box').html( data.visit_card );
            }
            if( data.html )$('#visit-form-box').html( data.html );
		break;
		}
	}
};}); })(jQuery);