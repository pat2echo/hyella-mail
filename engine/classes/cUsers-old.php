	...
	*/
	...
	class cUsers{
		...
		private function _get_all_admin_users(){
			...
			$query = "SELECT ".$select." FROM `" . $this->class_settings['database_name'] . "`.`".$this->table_name."` WHERE `record_status` = '1' AND `".$this->table_name."`.`".$this->table_fields["role"]."` != '1300130013' ORDER BY `".$this->table_name."`.`".$this->table_fields["firstname"]."` ";
