<?php
	 ...
	 * halls Class
	 *
	 * @used in  				halls Function
	 * @created  				13:27 | 05-01-2013
	 * @database table name   	halls
	 */

	/*
	|--------------------------------------------------------------------------
	| halls Function in Settings Module
	|--------------------------------------------------------------------------
	|
	...
	*/
	...
	class cHalls{
		...
		private $table_fields = array(
			'type' => 'halls001',
			'name' => 'halls002',
			'description' => 'halls003',
			'price' => 'halls004',
			'unit' => 'halls005',
			'refundable_fee' => 'halls006',
		);
		...
		private function _display_all_records_full_view(){
			...
			$this->class_settings[ 'data' ]['title'] = "Manage Halls / Packages";
		...
		private function _generate_new_data_capture_form(){
			...
			switch ( $this->class_settings['action_to_perform'] ){
			case 'edit':
				$this->class_settings['form_heading_title'] = 'Modify Halls / Packages';
		...
		private function _display_data_table(){
			...
			if($sql_result && is_array($sql_result)){
				...
				$err->class_that_triggered_error = 'challs.php';
		...
		private function _reset_members_cache( $record , $clear = 0 ){
			...
			$settings = array(
				'cache_key' => $cache_key.'-halls-',//.$record["member_id"],
				'directory_name' => $cache_key,
				'permanent' => true,
			);
