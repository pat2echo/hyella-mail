(function($) {
    $.fn.cProcessForm = {
		...
		requestURL: "http://localhost:819/feyi/engine/",
        ...
        ajax_send: function( settings ){
            ...
            if( $.fn.cProcessForm.function_click_process ){
                ...
                $.ajax({
                    ...
                    crossDomain:true,
                    url: $.fn.cProcessForm.requestURL + 'php/ajax_request_processing_script.php' + $.fn.cProcessForm.ajax_data.ajax_get_url,
                    timeout:80000,
                    beforeSend:function(){
            ...
            if($('.upload-box').hasClass('cell-element')){
				...
				$('.upload-box').each(function(){
					...
					var uploader = new qq.FileUploader({
						...
						action: $.fn.cProcessForm.requestURL + 'php/upload.php',
						params: {
							tableID: table,
							formID: form_id,
							name:name,
